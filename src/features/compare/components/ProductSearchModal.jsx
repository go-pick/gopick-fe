...
// 임시 더미 데이터 (나중에는 Supabase에서 가져옵니다)
const MOCK_ALL_PRODUCTS = [
    { id: 101, name: 'iPhone 15', category: 'Smartphone' },
    { id: 102, name: 'iPhone 15 Pro Max', category: 'Smartphone' },
    { id: 103, name: 'Galaxy S24 Ultra', category: 'Smartphone' },
    { id: 104, name: 'Galaxy Z Flip 5', category: 'Smartphone' },
    { id: 105, name: 'Pixel 8 Pro', category: 'Smartphone' },
    { id: 106, name: 'Xiaomi 13', category: 'Smartphone' },
];
...
const ProductSearchModal = ({ isOpen, onClose, onSelect, currentCategorySlug }) => {
    ...
    // ... (이하 handleBack, handleVariantSelect 및 렌더링 로직, 스타일은 기존과 동일)
...
const SummaryImage = styled.div`
    ...
    img {
        width: 100%;
        height: 100%;	
        object-fit: cover; // 이미지가 비율을 유지하며 영역을 꽉 채우도록 설정 (중요!)
    }
`;
